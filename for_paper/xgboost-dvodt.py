...
feature_names = np.array(['x', 'y', 'hour', 'month',
       ...
       'mean_u200', 'mean_u500', 'mean_u850',# 'mean_v500',
...
ax1.set_xlabel("Shapley value (10$^{-5}$ s$^{-1}$ day$^{-1}$)", fontsize=10)
...
ax2.set_xlabel("Predicted $\partial\zeta_{850}/\partial t$ (10$^{-5}$ s$^{-1}$ day$^{-1}$)")
ax2.set_ylabel("Actual $\partial\zeta_{850}/\partial t$ (10$^{-5}$ s$^{-1}$ day$^{-1}$)")

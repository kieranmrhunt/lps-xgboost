...
df = df.dropna(subset=['mean_prcp_imerg',])
...
ax1.set_xlabel("Shapley value (mm hr$^{-1}$)", fontsize=10)
...
ax2.set_ylabel("Predicted precipitation (mm hr$^{-1}$)")
ax2.set_xlabel("Actual precipitation (mm hr$^{-1}$)")
